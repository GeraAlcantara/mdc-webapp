...
function CourseContent({
  ...
  return (
    <section className="mt-8 h-full flex flex-col bg-brandBlue-500 w-full lg:w-auto rounded-xl select-none ">
      ...
      <hr />
      <ul className="p-4 md:max-h-[700px] lg:max-h-[590px] md:pr-4 lg:pr-6 md:overflow-y-scroll ">
