...
function CardsCarousel({ coursename, numtopics, thumbnail, thumbnailAlt, numlessons, duration, slug }) {
  return (
    <Link href={slug}>
      <div className='group flex flex-col w-[250px] md:w-[300px] lg:w-[250px] m-auto xl:w-[300px] h-[450px] rounded-2xl bg-brandBlue-500 hover:bg-brandBlue-600 overflow-hidden justify-between hover:cursor-pointer '>
