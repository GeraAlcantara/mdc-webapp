            ...
            <div className=''>
              {linkPreview.image && (
                <picture>
                  ...
                  <img src={linkPreview.image} alt={linkPreview.imageAlt ? linkPreview.imageAlt : ""} />
                </picture>
              )}
              <div className='p-4 bg-gray-100'>
                ...
                {linkPreview.siteName ? <span className='text text-gray-500'>{linkPreview.siteName}</span> : null}
                <br />
                {!linkPreview.url || !linkPreview.siteName ? (
                  linkPreview.canonical ? (
                    //remove https:// and www. from url
                    <span className='text-sm text-gray-500'>{linkPreview.canonical.replace(/(^\w+:|^)\/\//, "").replace("www.", "")}</span>
                  ) : null
                ) : null}
              </div>
            </div>
