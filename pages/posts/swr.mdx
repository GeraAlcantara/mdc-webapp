...
tags:
  ...
  - javascript
date: 2022-12-15
excerpt: SWR is a great package from Zeit to help make it easier to fetch remote data with hooks. It is based on the stale-while-revalidate RFC. In this post, I'll explain how it works.
descriptionSEO: SWR is a great package to help make it easier to fetch remote data with hooks. It is based on the stale-while-revalidate RFC.
...
authorAvatar: avatarPerson.jpg
authorName: Luis Villa
